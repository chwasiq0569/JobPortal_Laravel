<!doctype html>
<html lang="en">
@push('css') <link href="/index.css" rel="stylesheet"> @endpush
<x-header></x-header>
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="d-flex" role="search">
            ...
            @auth
                <a href="/dashboard" class="signInBtn">Dashboard</a>
            @endauth
  ...
  <div class="card mt-4">
    <div class="card-body searchContainerBg py-5">
      <div class="flex justify-content-center row py-5 searchContainer">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 item-gutter my-1">
            <form action="/search" method="POST">
                @csrf
          <input type="text" class="form-control py-2" placeholder="Enter Skill" name="skill" aria-label="First name">
        </div>
        <!-- <div class="col-lg-3 col-md-6 col-sm-12 item-gutter  my-1">
          <input type="text" class="form-control py-2" placeholder="Enter Classification" aria-label="Last name">
        </div> -->
        <div class="col-lg-3 col-md-6 col-sm-12 item-gutter  my-1">
          <input type="text" class="form-control py-2" placeholder="Where" name="location" aria-label="Last name">
        </div>
        <div class="col-lg-2 col-md-12 col-sm-12 item-gutter  my-1">
          <input type="submit" class="searchBtn" value="Search" aria-label="Last name">
        </div>
        </form>
      </div>
    </div>
    ...
    @guest
        <div class="container-fluid">
            <div class="card text-center m-0 mt-5 dullBG border-0">
            <div class="card-body m-4">
                <!-- <button class="signInBtn" type="submit">Sign In</button> -->
                <a href="/login" class="signInBtn">Sign In</a>
                <a href="/register" class="registerTxt">Register</a>
                <br />
                <br />
                <p class="card-text m-2"><small>Sign in to manage your SEEK Profile, save searches and view your
                    recommended jobs.</small></p>
            </div>
            </div>
        </div>
    @endguest
  ...
  <div class="container mt-5">
    ...
    @foreach($searchUsers as $users)
        <a style="text-decoration: none; all: unset;" href="/profile/{{$users->user_id}}">
        <div class="userCard">
            <h4 class="userName"><span>{{$users->name}}</span></h4>
  ...
  <div class="container-fluid">
    <footer class="row row-cols-5 px-3 py-5 mt-5 border-top footerContainer">
      <div class="col-lg-3 col-sm-6 col-12 my-2">
        <a href="/" class="d-flex align-items-center mb-3 link-dark text-decoration-none">
          <svg viewBox="0 0 170 68" height="45">
            <path class="_1ljm6lk0"
      ...
      <div class="col-lg-3 col-sm-6 col-12  my-2 fontStyles">
        <h5>Job seekers</h5>
        <ul class="nav flex-column">
          <li class="nav-item mb-2"><a href="profile.html" class="nav-link p-0 text-muted">Employee Seekers</a></li>
          <li class="nav-item mb-2"><a href="signup.html" class="nav-link p-0 text-muted">Register</a></li>
      ...
      <div class="col-lg-3 col-sm-6 col-12  my-2 fontStyles">
        <h5>Employers</h5>
        <ul class="nav flex-column">
          <li class="nav-item mb-2"><a href="profile.html" class="nav-link p-0 text-muted">Register for free</a></li>
          <li class="nav-item mb-2"><a href="signup.html" class="nav-link p-0 text-muted">Post a Job ad</a></li>
          <li class="nav-item mb-2"><a href="login.html" class="nav-link p-0 text-muted">Hiring advice</a></li>
        </ul>
      </div>
      ...
      <div class="col-lg-3 col-sm-6 col-12  my-2 fontStyles">
        <h5>Contact</h5>
        <ul class="nav flex-column">
          <li class="nav-item mb-2"><a href="profile.html" class="nav-link p-0 text-muted">Help Center</a></li>
          <li class="nav-item mb-2"><a href="signup.html" class="nav-link p-0 text-muted">Contact Us</a></li>
          <li class="nav-item mb-2"><a href="login.html" class="nav-link p-0 text-muted">Social</a></li>
        </ul>
      </div>
    </footer>
  </div>
